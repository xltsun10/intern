...
function Content (props)  {
  ...
  return (
    <div>
      <MovieRow movies={NetflixOriginals} title= "Netfix Originals" isNetflix={true} idSection="netflix"/>
      <MovieRow movies={TrendingMovies} title= "Treding Movies" idSection="trending"/>
      <MovieRow movies={TopRatedMovies} title= "Top rated" idSection="topRated"/>
      <MovieRow movies={ActionMovies} title= "Action Originals" idSection="actionMovies"/>
      <MovieRow movies={ComedyMovies} title= "Comedy Originals" idSection="comedyMovies"/>
      <MovieRow movies={HorrorMovies} title= "Horror Originals" idSection="horrorMovies"/>
      <MovieRow movies={RomanceMovies} title= "Romance Originals" idSection="romanceMovies"/>
      <MovieRow movies={Documentaries} title= "Documentaries Originals" idSection="documentaries"/>
      <GoToTop
        onClick={() => scrollToTop()}
        style={{
          visibility: `${
